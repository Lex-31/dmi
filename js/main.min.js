...
const video = document.querySelector('.featured-right__video-inner video');
video.volume = 0.3; //громкость на 50% выставляем
...
video.onclick = function () { //когда кликаем на видео
